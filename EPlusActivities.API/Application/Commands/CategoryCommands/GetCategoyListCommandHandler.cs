...
{
    public class GetCategoyListCommandHandler
        : BaseCommandHandler,
          IRequestHandler<GetCategoryListCommand, IEnumerable<CategoryDto>>
    {
        public GetCategoyListCommandHandler(
        ...
        public async Task<IEnumerable<CategoryDto>> Handle(
            GetCategoryListCommand request,
