...
{
    public class GetActivityUserQueryHandler
        : ActivityUserRequestHandlerBase,
          IRequestHandler<GetActivityUserQuery, ActivityUserDto>
    {
        public GetActivityUserQueryHandler(
