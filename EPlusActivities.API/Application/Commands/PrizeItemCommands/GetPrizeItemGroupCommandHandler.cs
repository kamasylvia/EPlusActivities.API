...
{
    public class GetPrizeItemGroupCommandHandler
        : BaseCommandHandler,
          IRequestHandler<GetPrizeItemGroupCommand, IEnumerable<PrizeItemDto>>
    {
        public GetPrizeItemGroupCommandHandler(
        ...
        public async Task<IEnumerable<PrizeItemDto>> Handle(
            GetPrizeItemGroupCommand request,
