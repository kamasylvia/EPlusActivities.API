...
{
    public class GetCategoryByContainedNameQueryHandler
        : CategoryRequestHandlerBase,
          IRequestHandler<GetCategoryByContainedNameQuery, CategoryDto>
    {
        public GetCategoryByContainedNameQueryHandler(
            INameExistsRepository<Category> categoryRepository,
            IMapper mapper
        ) : base(categoryRepository, mapper) { }

        public async Task<CategoryDto> Handle(
            GetCategoryByContainedNameQuery request,
