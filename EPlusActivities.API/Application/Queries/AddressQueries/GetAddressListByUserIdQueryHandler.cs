...
{
    public class GetAddressListByUserIdQueryHandler
        : AddressRequestHandlerBase,
          IRequestHandler<GetAddressListByUserIdQuery, IEnumerable<AddressDto>>
    {
        public GetAddressListByUserIdQueryHandler(
        ...
        public async Task<IEnumerable<AddressDto>> Handle(
            GetAddressListByUserIdQuery request,
