...
namespace EPlusActivities.API.Data.Migrations.ApplicationDb
{
    public partial class AppDbMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        BackgroundPhotoUrl = table.Column<string>(nullable: true)
                    },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        RegisterChannel = table.Column<int>(nullable: false),
                        LoginChannel = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrizePhoto", x => x.Id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrizeItems_PrizePhoto_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "PrizePhoto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict
                    );
                }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "PrizePhoto");
