    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
            ...
            CreateMap<Activity, ActivityDto>()
                .ForMember(dest => dest.AvailableChannels,
                opt =>
                    opt
                        .MapFrom(src =>
                            src
                ...
                opt =>
                    opt
                        .MapFrom(src =>
                            src
                                .AvailableChannels
                                .Select(channelString =>
                                    Enum
                                        .Parse<ChannelCode>(channelString,
                                        true))));
            ...
            CreateMap<ActivityUser, ActivityUserDto>()
                .ForMember(dest => dest.RequiredCreditForRedeeming,
                opt =>
                    opt
                        .MapFrom(src =>
                            src.Activity.RequiredCreditForRedeeming));
            ...
            CreateMap<MemberForUpdateCreditResponseDto, Credit>()
                ...
                .ForMember(dest => dest.NewPoints,
                opt => opt.MapFrom(src => src.Body.Content.NewPoints))
                .ForMember(dest => dest.OldPoints,
            ...
            CreateMap<UploadFileCommand, UploadFileGrpcRequest>()
                ...
                opt =>
                    opt
                        .MapFrom(src =>
                            ByteString
                                .FromStream(src.FormFile.OpenReadStream())));
