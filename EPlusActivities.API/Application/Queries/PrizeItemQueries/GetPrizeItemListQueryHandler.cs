...
{
    public class GetPrizeItemListQueryHandler
        : PrizeItemRequestHandlerBase,
          IRequestHandler<GetPrizeItemListQuery, IEnumerable<PrizeItemDto>>
    {
        public GetPrizeItemListQueryHandler(
