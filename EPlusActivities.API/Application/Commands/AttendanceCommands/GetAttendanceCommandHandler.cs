...
{
    public class GetAttendanceCommandHandler
        : BaseCommandHandler,
          IRequestHandler<GetAttendanceCommand, AttendanceDto>
    {
        public GetAttendanceCommandHandler(
