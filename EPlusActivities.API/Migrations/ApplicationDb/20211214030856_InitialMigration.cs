...
namespace EPlusActivities.API.Migrations.ApplicationDb
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            RequiredCreditForRedeeming = table.Column<int>(
                                type: "int",
                                nullable: true
                            ),
                            Name = table
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_LotterySummaries", x => x.Id);
                        table.UniqueConstraint(
                            "AK_LotterySummaries_ActivityId_Channel_Date",
                            x => new { x.ActivityId, x.Channel, x.Date }
                        );
                        table.ForeignKey(
                            name: "FK_LotterySummaries_Activities_ActivityId",
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            SequentialAttendanceDays = table.Column<int>(
                                type: "int",
                                nullable: true
                            ),
                            LastAttendanceDate = table.Column<DateTime>(
                                type: "datetime(6)",
                                nullable: true
                            )
                        },
                    ...
                    {
                        table.PrimaryKey(
                            "PK_ActivityUserLinks",
                            x => new { x.ActivityId, x.UserId }
                        );
                        table.ForeignKey(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            Recipient = table
                                .Column<string>(type: "longtext", nullable: true)
                                .Annotation("MySql:CharSet", "utf8mb4"),
                            RecipientPhoneNumber = table
                                .Column<string>(type: "varchar(11)", maxLength: 11, nullable: true)
                                .Annotation("MySql:CharSet", "utf8mb4"),
                            Region = table
                                .Column<string>(type: "longtext", nullable: true)
                                .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            UserId1 = table.Column<Guid>(
                                type: "char(36)",
                                nullable: true,
                                collation: "ascii_general_ci"
                            ),
                            RoleId1 = table.Column<Guid>(
                                type: "char(36)",
                                nullable: true,
                                collation: "ascii_general_ci"
                            )
                ...
                .CreateTable(
                    ...
                    columns: table =>
                        new
                        {
                            ...
                            PickedUpTime = table.Column<DateTime>(
                                type: "datetime(6)",
                                nullable: true
                            ),
                            ChannelCode = table.Column<int>(type: "int", nullable: false),
                    ...
                    constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            name: "FK_LotteryDetails_Activities_ActivityId",
                            column: x => x.ActivityId,
                            principalTable: "Activities",
                            principalColumn: "Id"
                        );
                        table.ForeignKey(
                            name: "FK_LotteryDetails_AspNetUsers_UserId",
                            column: x => x.UserId,
                            principalTable: "AspNetUsers",
                            principalColumn: "Id"
                        );
                        table.ForeignKey(
                            name: "FK_LotteryDetails_PrizeItems_PrizeItemId",
                            column: x => x.PrizeItemId,
                            principalTable: "PrizeItems",
                            principalColumn: "Id"
                        );
                        table.ForeignKey(
                            name: "FK_LotteryDetails_PrizeTiers_PrizeTierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LotteryDetails_ActivityId",
                table: "LotteryDetails",
                column: "ActivityId"
            );

            migrationBuilder.CreateIndex(
                name: "IX_LotteryDetails_PrizeItemId",
                table: "LotteryDetails",
                column: "PrizeItemId"
            );

            migrationBuilder.CreateIndex(
                name: "IX_LotteryDetails_PrizeTierId",
                table: "LotteryDetails",
                column: "PrizeTierId"
            );

            migrationBuilder.CreateIndex(
                name: "IX_LotteryDetails_UserId",
                table: "LotteryDetails",
                column: "UserId"
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "LotteryDetails");

            migrationBuilder.DropTable(name: "LotterySummaries");
